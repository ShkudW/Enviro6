...
def sniff_ndp_packets(iface):
    ...
    for i in range(3):
        ns_packet = IPv6(dst="ff02::1")/ICMPv6ND_NS(tgt="ff02::1")/ICMPv6NDOptSrcLLAddr(lladdr=get_if_hwaddr(iface))
        send(ns_packet)
        print(f"{Fore.CYAN}Neighbor Solicitation sent to ff02::1")
